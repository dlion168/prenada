...
const useBodyData = () => {
    ...
    //     let chars = usedChars;
    //     let curLetters = curGuess ? curGuess.split('') : [];
    //     let solutionLetters = solution.split('');
    //     let newGuess = [];
    //     curLetters.map((curLetter, index) => {
    //         if (chars[curLetter] === 'green' || curLetter === solutionLetters[index]) {
    //             chars[curLetter] = 'green'
    //         }
    //         else if (chars[curLetter] === 'yellow' || solutionLetters.includes(curLetter))
    //             chars[curLetter] = 'yellow'
    //         else
    //             chars[curLetter] = 'grey'

    //         newGuess.push({ 'char': curLetter, 'color': chars[curLetter] });
